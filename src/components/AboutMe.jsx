    ...
    <Section>
      <div className="flex justify-between flex-col md:flex-row gap-4 items-center">
        <div className=" flex items-center gap-4 md:flex-row  flex-col">
          <div className="bg-[#EDEDED] dark:bg-[#333333] relative size-[140px]  rounded-full overflow-hidden ">
            <img
              src={headShot}
              className="  w-full max-w-[130px] absolute bottom-0 left-[5%]  "
              alt="profile Photo"
            />
          </div>
          <span className>
            ...
            <p className="dark:text-[#c7c6c6] text-base ">
              {t("about.subtitle")}
            </p>
          </span>
        </div>
        ...
        <a
          href={i18n.language === "en-US" ? cvEn : cvES}
          download="Resume"
          target="_blank"
          className="bg-[#EDEDED] dark:bg-[#333333]  w-full max-w-44 h-12 hover:scale-105 transition-all rounded-3xl dark:text-white font-bold flex items-center justify-center gap-1"
        >
          {t("about.btn")}{" "}
